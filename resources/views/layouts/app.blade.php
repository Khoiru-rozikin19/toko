            ...
            <div id="sidebarMenu" class="flex-1 overflow-y-auto px-4 py-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-2 space-y-1">
                        ...
                        <a href="#" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800">
                ...
                <div>
                    ...
                    <div class="mt-2 space-y-1">
                        <a href="{{ Auth::check() ? route('admin.settings') : '#' }}" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800">
                        ...
                        <div>
                            ...
                            <div class="mt-2 space-y-1">
                                ...
                                @if(Auth::user()->role === 'admin')
                                    ...
                                    <a href="{{ route('admin.supplier_settings') }}" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl text-sm font-medium {{ request()->routeIs('admin.supplier_settings') ? 'bg-blue-50 dark:bg-blue-950/30 text-blue-600 dark:text-blue-400 border-l-4 border-blue-600' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800' }}">
        ...
        <div class="flex-1 md:ml-80 flex flex-col min-h-screen">
            ...
            <header class="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 h-20 px-6 md:px-10 flex items-center justify-between sticky top-0 z-20 transition-all duration-200">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="flex items-center space-x-2 px-4 py-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-xl text-sm font-semibold transition-all duration-200">
